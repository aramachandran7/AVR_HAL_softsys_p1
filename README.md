...
$ cd AVR_HAL_softsys_p1
```

## Usage 
Simply import the peripheral libraries of choice, define your `MCU`, and write short, intuitive, readable firmware with any of the library level API's. 

Sample code from `UART_sample.c` in `./examples/UART_sample.c`:   
